...
public class PathSelectDialog extends AlertDialog.Builder{
                ...
                .setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        if (selectedIndex > -1 && listener != null) {
                            listener.OnSelected(listView.getItemAtPosition(selectedIndex).toString());
                        }else if(selectedIndex == -1 && listener != null){
                            currentPath += "/";
                            listener.OnSelected(currentPath);
                        }
                    }
                })
    ...
    public PathSelectDialog setOpenDialogListener(OpenDialogListener listener) {
    ...
    private LinearLayout createMainLayout(Context context) {
        ...
        linearLayout.setMinimumHeight(getLinearLayoutMaxHeight(context));
        return linearLayout;
    }
    ...
    private static int getLinearLayoutMaxHeight(Context context) {
